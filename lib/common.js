/* TODO
  *** MUST BE ***
  YES - Que los barcos no se solapen
  YES - Mostrar lista de usuarios conectados
  - De los usuarios conectados mostrar los que están jugando y que no sean seleccionables
  ...
  - Detectar si es movil o web
  - Detectar final de partida (usuario que consigue hundir todos los barcos contrarios)
  ...
  - Sonidos de tocado, agua y hundido y paso de board al finalizar.
  ...
  *** NIQUEL ***
  - Mostrar lista de partidas activas y partidas jugandose (ambos usuarios online)
